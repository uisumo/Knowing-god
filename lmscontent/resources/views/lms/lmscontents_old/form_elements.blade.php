 <?php $settings = getSettings('lms');?>
				...
				<div class="row">
					 ...
					 <fieldset class="form-group col-md-6">
						...
						<span class="text-red">*</span>
						{{ Form::text('code', $value = null , $attributes = array('class'=>'form-control', 'placeholder' => 'PSGS',
							'ng-model'=>'code',
							'required'=> 'true', 
							'ng-pattern' => getRegexPattern("name"),
							'ng-minlength' => '2',
					...
					<fieldset class="form-group col-md-6" >
						{{ Form::label('parent_id', getphrase('parent')) }}
						<span class="text-red">*</span>
						
						{{Form::select('parent_id', $contents, null, ['placeholder' => getPhrase('select'),'class'=>'form-control', 
						'ng-model'=>'parent_id',
