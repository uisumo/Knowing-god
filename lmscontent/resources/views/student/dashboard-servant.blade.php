    ...
    <div class="col-sm-12"> 
        <ol class="breadcrumb">
          ...
          <div class="container-pad">
					...
					?>
                    <div class="profile-card" style="background: url(<?php echo IMAGES; ?>servant-bg.png) center no-repeat;">
						...
						<img src="{{IMAGES}}servant-banner.svg" alt="{{getPhrase('Servant')}}++" title="{{getPhrase('Servant')}}++">
                        </div>
                        @include('student.dashboard-parts.help-pathway')
                        @include('student.dashboard-parts.pins-part', array('subjects' => $subjects, 'dashboard' => 'servant_dashboard'))
                    </div>
