    ...
    <div class="col-sm-12"> 
        <ol class="breadcrumb">
          ...
          <div class="container-pad">
					...
					?>
                    <div class="profile-card" style="background: url(<?php echo IMAGES; ?>learner-bg.png) center no-repeat;">
						...
						<img src="{{IMAGES}}learner-banner.svg" alt="{{getPhrase('Servant Learner')}}++" title="{{getPhrase('Servant Learner')}}++">
                        </div>
                        @include('student.dashboard-parts.help-pathway')
                        @include('student.dashboard-parts.pins-part', array('subjects' => $subjects, 'dashboard' => 'learner_dashboard'))
                    </div>
