...
<div id="page-wrapper" ng-model="academia" ng-controller="instructions">
    ...
    <div class="panel panel-custom col-lg-12" >
                    <div class="panel-heading instruction-heading mt-2">
                        <h4>{{getPhrase('Instructions')}} <span class="pull-right text-italic">{{getPhrase('please_read_the_instructions_carefully')}}</span></h4>
