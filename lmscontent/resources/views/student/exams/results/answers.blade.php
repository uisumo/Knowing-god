                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb mt-2">
                            ...
                            <li class="breadcrumb-item"><a href="{{URL_STUDENT_ANALYSIS_BY_EXAM.$user_details->slug}}">{{getPhrase('analysis')}}</a></li>

                            <li class="breadcrumb-item active">{{$exam_record->title.' '.getPhrase('answers')}}</li>
                ...
                <div class="expand-card card-normal mt-3">
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <h4 class="mb-0 mt-3">{{$exam_record->title}}



                            <span class="pull-right">
                            <?php
                            $exam_status = $result_record->exam_status;
                            if ( $exam_status == 'pass' ) {
                                $exam_status = getPhrase('passed');
                            }
                            ?>
                            {{getPhrase('result').': '.$exam_status}}
...
<div class="d_but ans-btns">
     ...
     <a class="btn btn-lg btn-success button next float-lg-right
               " href="{{URL_STUDENT_MY_COURSES}}">{{getPhrase('my_courses')}}</a>
 </div>
