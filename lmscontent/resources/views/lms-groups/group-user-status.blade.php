...
<ol class="breadcrumb mt-3">
	...
	<li class="breadcrumb-item"><a href="{{URL_FRONTEND_LMSSERIES . $group->slug}}">{{getPhrase('Courses')}} ({{$group->title}} )</a></li>
...
<div class="row mt-2">
	<div class="col-sm-12">
		<h4><i class="fa fa-video-camera"></i> {{$title}} Lessons</h4>
	</div>
</div>
	...
	<div class="col-lg-6 mb-4">
		<div class="card h-100 text-center video-list-card">
			<div class="card-content">
				...
				if ( is_completed( $content->id, '', 'content', $user->id ) ) {
