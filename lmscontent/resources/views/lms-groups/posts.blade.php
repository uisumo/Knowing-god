			...
			<div class="container-fluid">
				...
				<div class="panel panel-custom">
					<div class="panel-heading">
						<?php
						$button_title = getPhrase('add_posts');
						$url = URL_LMS_ADD_GROUP_POSTS . $group_slug;
						?>
						@if( is_group_owner( $group_details->id ) )
...
@section('footer_scripts')
	...
	@include('common.datatables', array('route'=>URL_LMS_GROUP_GET_POSTS . '/' . $group_slug, 'route_as_url' => 'yes' ))
