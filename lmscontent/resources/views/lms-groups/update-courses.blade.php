                ...
                <div class="expand-card card-normal mt-3 ">
                    ...
                    <?php $button_name = getPhrase('create'); ?>
                            ...
                            <fieldset class="form-group col-md-6">
                                ...
                                {{Form::select('lms_categories', $pathways, null, ['class'=>'form-control', 'ng-model' => 'category_id',

                                'placeholder' => 'Select', 'ng-change'=>'categoryChangedCourses(category_id)' ])}}
                        ...
                        <?php $lmssettings = getSettings('lms');?>
                            ...
                            <fieldset class="form-group col-md-6">
                                ...
                                {{Form::select('lms_category_id', $categories, null, ['class'=>'form-control', 'ng-model' => 'lms_category_id',
...
<div class="table-responsive">
                                <table
                                  ...
                                  class="table table-hover">
                                    ...
                                    <tr ng-repeat="item in categoryItems | filter : {lms_category_id: lms_category_id} | filter:search_term  track by $index">
