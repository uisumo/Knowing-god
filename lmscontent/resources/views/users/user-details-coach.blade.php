				...
				<div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb mt-3">
							...
							<li class="breadcrumb-item"><a href="{{URL_PARENT_CHILDREN}}">{{ getPhrase('users') }}</a> </li>
							@endif
					...
					<div class="panel-body">
						...
						<div class="col-lg-3 col-md-6">
							<div class="card card-red text-xs-center">
								<div class="card-block">
									...
									<p class="card-text">{{ getPhrase('donations')}}</p>
								</div>
						...
						<div class="col-lg-3 col-md-6">
							<div class="card card-red text-xs-center">
								<div class="card-block">
									<h4 class="card-title"><i class="fa fa-credit-card"></i></h4>
									<p class="card-text">{{ getPhrase('groups')}}</p>
								</div>
									<a class="card-footer text-muted" href="{{URL_ADMIN_ALL_LMSGROUPS . '/' .$record->slug}}">{{ getPhrase('view_details')}}</a>
							</div>
						</div>
