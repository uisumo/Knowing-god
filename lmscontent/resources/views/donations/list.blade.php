            ...
            <div class="container-fluid">
                ...
                <div class="panel panel-custom">
                    ...
                    <div class="panel-heading">
                        ...
                        <div class="pull-right messages-buttons mb-3">
                            <a href="{{URL_STUDENT_DONATIONS_INDEX}}" class="btn  btn-primary button" >{{ getPhrase('donate')}}</a>
                        </div>
                        @endif
...
@section('footer_scripts')
 ...
 @include('common.datatables', array('route'=>URL_PAYPAL_DONATIONS_AJAXLIST.$user->slug, 'route_as_url' => TRUE))
