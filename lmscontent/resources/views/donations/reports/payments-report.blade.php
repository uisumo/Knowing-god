        ...
        <div class="row">
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="media stats-media bg-secondary text-xs-center">
                    ...
                    </div> <a class="states-link" href="{{URL_ONLINE_DONATIONS_REPORT_DETAILS}}all">
								{{ getPhrase('view_all')}}
							</a> </div>
            </div>
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div class="media stats-media bg-success text-xs-center">
                    ...
                    <div class="media-body">
                        ...
                        <p class="card-text">{{ getPhrase('success')}}</p>
							...
							{{URL_ONLINE_DONATIONS_REPORT_DETAILS}}
							@else {{URL_ONLINE_DONATIONS_REPORT_DETAILS}}
							@endif
							success">
								{{ getPhrase('view_all')}}
							</a> </div>
