					...
					<div class='form-group'>
						...
						<div class="col-sm-2">
							{{ Form::radio('all_records', 1, true, array('id'=>'paid', 'name'=>'all_records', 'ng-model'=>'all_records')) }}
								<label for="paid"> <span class="fa-stack radio-button">  </span> {{getPhrase('Yes')}} </label>
							</div>
							<div class="col-sm-2">
							{{ Form::radio('all_records', 0, false, array('id'=>'free', 'name'=>'all_records', 'ng-model'=>'all_records')) }}
								
								<label for="free"> <span class="fa-stack radio-button"></span> {{getPhrase('No')}}</label> 
							</div>
					 ...
					 <div class='form-group'>
						...
						<div class="row">
							...
							{{ Form::radio('payment_type', 'all', true, array('id'=>'free1', 'name'=>'payment_type')) }}
								...
								<label for="free1"> <span class="fa-stack radio-button">  </span> {{getPhrase('all')}}</label> 
							</div>
							<div class="col-md-2">
							{{ Form::radio('payment_type', 'online', false, array('id'=>'paid1', 'name'=>'payment_type')) }}
								<label for="paid1"> <span class="fa-stack radio-button"> </span> {{getPhrase('online')}} </label>
							</div>
							<?php /* ?>
							<div class="col-md-2">
							{{ Form::radio('payment_type', 'offline', false, array('id'=>'offline', 'name'=>'payment_type')) }}
								<label for="offline"> <span class="fa-stack radio-button">  </span> {{getPhrase('offline')}} </label>
							</div>
							<?php */ ?>
						</div>
					</div>
					 ...
					 <div class='form-group'>
						...
						<div class="row">
							...
							{{ Form::radio('payment_status', 'all', true, array('id'=>'payment_status_all', 'name'=>'payment_status')) }}
								...
								<label for="payment_status_all"> <span class="fa-stack radio-button">  </span> {{getPhrase('all')}}</label> 
							</div>
							<div class="col-md-2">
							{{ Form::radio('payment_status', 'success', false, array('id'=>'payment_status_success', 'name'=>'payment_status')) }}
								<label for="payment_status_success"> <span class="fa-stack radio-button"> </span> {{getPhrase('success')}} </label>
							</div>
							<div class="col-md-2">
							{{ Form::radio('payment_status', 'pending', false, array('id'=>'payment_status_pending', 'name'=>'payment_status')) }}
								<label for="payment_status_pending"> <span class="fa-stack radio-button">  </span> {{getPhrase('pending')}} </label>
							</div>
							<div class="col-md-2">
							{{ Form::radio('payment_status', 'cancelled', false, array('id'=>'payment_status_cancelled', 'name'=>'payment_status')) }}
								<label for="payment_status_cancelled"> <span class="fa-stack radio-button">  </span> {{getPhrase('cancelled')}} </label>
							</div>
						</div>
					</div>
