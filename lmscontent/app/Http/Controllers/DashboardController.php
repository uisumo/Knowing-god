...
class DashboardController extends Controller
{
    ...
    public function index()
    {
     ...
     // $data['right_bar_data']     = array('chart_data' => $data['chart_data'] );
        ...
        else if($role == 'student' )
        {
			...
			$courses_completed = $summary['courses']['completed'];
			$modules_completed = $summary['modules']['completed'];
			$lessons_completed = $summary['lessons']['completed'];
						
			$dashboard_view = 'student.dashboard';
			if ( 'Servant Learner' === get_current_user_level()
				) {
				$dashboard_view = 'student.dashboard-learner';
			} elseif ( 'Servant Servant' === get_current_user_level()
				) {
				$dashboard_view = 'student.dashboard-servant';
			}elseif ( 'Servant Leader' === get_current_user_level()
				) {
				$dashboard_view = 'student.dashboard-servant-leader';
			}	
	...
	public function userDashboard()
    {
        ...
        if($role=='admin' || $role=='owner' || $role == 'student' )
        {
			...
			if($user->settings)
			{
			  $interested_subjects =  json_decode($user->settings)->user_preferences;
			}
    ...
    {
        $paymentObject = new App\Donations();
	...
	{
		$data = array();
		return view('student.dashboard-learner', $data);
	}
	
	public function servant()
	{
		$data = array();
		return view('student.dashboard-servant', $data);
	}
	
	public function servantLeader()
	{
		$data = array();
		return view('student.dashboard-servant-leader', $data);
	}
}
