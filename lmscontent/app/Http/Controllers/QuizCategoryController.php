...
class QuizCategoryController extends Controller
{
    ...
    public function getDatatable()
    {
        ...
        if(!checkRole(getUserGrade(2)))
        {
         ...
         $records = QuizCategory::select([   
         	'category', 'image', 'description', 'category_status', 'id','slug'])
    ...
    public function update(Request $request, $slug)
    {
       ...
       $this->validate($request, $rules);
		...
		$record->category_order		= $request->category_order;
		
		$record->category_status	= $request->category_status;
     ...
     public function processUpload(Request $request, $record, $file_name)
     {
        ...
        return ;
         ...
         //Save Normal Image with 300x300
          Image::make($destinationPath.$fileName)->fit($examSettings->imageSize_width, $examSettings->imageSize_height)->save($destinationPath.$fileName);
         return $fileName;
        }
     }
}
