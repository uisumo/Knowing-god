...
class MessagesController extends Controller
{
    ...
    public function index( $unread = '' )
    {
		...
		if ( ! empty( $unread ) && $unread == 'unread' ) {
			$threads = Thread::forUserWithNewMessages($currentUserId)->latest('updated_at')->paginate(getRecordsPerPage());
		} else {
