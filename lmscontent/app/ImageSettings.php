...
class ImageSettings extends Model
{
	...
	protected $profileThumbPicSize = 150;
	...
	// protected $defaultprofilePicsThumbnailpath = "https://goo.gl/qDzexi";
     ...
     * @return [numeric] [description]
     */
    public function getProfileThumbnailSize()
    {
        return $this->profileThumbPicSize;
    }
